    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(cors -> cors.disable()).csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(antMatcher("/api/diaryEntry/update/:id")).hasAnyRole("USER", "ADMIN")
                .requestMatchers(antMatcher("/api/diaryEntry/delete/:id")).hasAnyRole("USER", "ADMIN")
                .requestMatchers(antMatcher("api/diaryEntry/moods")).hasAnyRole("USER", "ADMIN")
