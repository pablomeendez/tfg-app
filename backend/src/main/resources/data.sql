...
INSERT INTO Habit (name, description, image, categoryId) SELECT * FROM (VALUES
    ('{"en": "Drink Water", "es": "Beber agua", "gl": "Beber auga"}', '{"en": "Stay hydrated by drinking plenty of water", "es": "Mantente hidratado bebiendo mucha agua", "gl": "Mantente hidratado bebendo moita auga"}', 'habit_water.png', 1),
    ('{"en": "Exercise", "es": "Ejercicio", "gl": "Exercicio"}', '{"en": "Stay active with regular exercise", "es": "Mantente activo con ejercicio regular", "gl": "Mantente activo con exercicio regular"}', 'habit_exercise.png', 4),
    ('{"en": "Read a Book", "es": "Leer un libro", "gl": "Ler un libro"}', '{"en": "Expand your knowledge by reading", "es": "Expande tu conocimiento leyendo", "gl": "Expande o teu coñecemento lendo"}', 'habit_read.png', 2),
    ('{"en": "Meditate", "es": "Meditar", "gl": "Meditar"}', '{"en": "Practice mindfulness and meditation", "es": "Practica la atención plena y la meditación", "gl": "Practica a atención plena e a meditación"}', 'habit_meditate.png', 3),
    ('{"en": "Get 8 Hours of Sleep", "es": "Dormir 8 horas", "gl": "Durmir 8 horas"}', '{"en": "Ensure adequate rest with 8 hours of sleep", "es": "Asegura un descanso adecuado con 8 horas de sueño", "gl": "Asegura un descanso adecuado con 8 horas de sono"}', 'habit_sleep.png', 1),
    ('{"en": "Practice Gratitude", "es": "Practicar la gratitud", "gl": "Practicar a gratitude"}', '{"en": "Reflect on things you are grateful for", "es": "Reflexiona sobre las cosas por las que estás agradecido", "gl": "Reflexiona sobre as cousas polas que estás agradecido"}', 'habit_gratitude.png', 9),
    ('{"en": "Take a Walk", "es": "Dar un paseo", "gl": "Dar un paseo"}', '{"en": "Go for a walk to stay active and enjoy nature", "es": "Sal a caminar para mantenerte activo y disfrutar de la naturaleza", "gl": "Sae a camiñar para manterte activo e gozar da natureza"}', 'habit_walk.png', 4),
    ('{"en": "Call Family/Friends", "es": "Llamar a la familia/amigos", "gl": "Chamar á familia/amigos"}', '{"en": "Stay connected with loved ones", "es": "Mantente conectado con tus seres queridos", "gl": "Mantente conectado cos teus seres queridos"}', 'habit_call.png', 7),
    ('{"en": "Learn Something New", "es": "Aprender algo nuevo", "gl": "Aprender algo novo"}', '{"en": "Dedicate time to learning a new skill or topic", "es": "Dedica tiempo a aprender una nueva habilidad o tema", "gl": "Dedica tempo a aprender unha nova habilidade ou tema"}', 'habit_learn.png', 2),
    ('{"en": "Deep Clean", "es": "Limpieza profunda", "gl": "Limpeza profunda"}', '{"en": "Thoroughly clean your living space", "es": "Limpia a fondo tu espacio vital", "gl": "Limpa a fondo o teu espazo vital"}', 'habit_clean.png', 5),
    ('{"en": "Hobby Time", "es": "Tiempo de pasatiempos", "gl": "Tempo de pasatempos"}', '{"en": "Spend time on your favorite hobby", "es": "Dedica tiempo a tu pasatiempo favorito", "gl": "Dedica tempo ao teu pasatempo favorito"}', 'habit_hobby.png', 6),
    ('{"en": "Meal Prep", "es": "Preparar comidas", "gl": "Preparar comidas"}', '{"en": "Prepare healthy meals for the week", "es": "Prepara comidas saludables para la semana", "gl": "Prepara comidas saudables para a semana"}', 'habit_meal.png', 1),
    ('{"en": "Digital Detox", "es": "Desintoxicación digital", "gl": "Desintoxicación dixital"}', '{"en": "Take a break from digital devices", "es": "Tómate un descanso de los dispositivos digitales", "gl": "Tómate un descanso dos dispositivos dixitais"}', 'habit_detox.png', 3),
    ('{"en": "Review Goals", "es": "Revisar objetivos", "gl": "Revisar obxectivos"}', '{"en": "Reflect on and adjust your goals", "es": "Reflexiona y ajusta tus objetivos", "gl": "Reflexiona e axusta os teus obxectivos"}', 'habit_goals.png', 8),
    ('{"en": "Complete a Project", "es": "Completar un proyecto", "gl": "Completar un proxecto"}', '{"en": "Finish a personal or work project", "es": "Termina un proyecto personal o de trabajo", "gl": "Remata un proxecto persoal ou de traballo"}', 'habit_project.png', 8),
    ('{"en": "Financial Review", "es": "Revisión financiera", "gl": "Revisión financeira"}', '{"en": "Review and plan your finances", "es": "Revisa y planifica tus finanzas", "gl": "Revisa e planifica as túas finanzas"}', 'habit_finance.png', 8),
    ('{"en": "Plan Adventure", "es": "Planificar aventura", "gl": "Planificar aventura"}', '{"en": "Plan an exciting activity or trip", "es": "Planifica una actividad emocionante o viaje", "gl": "Planifica unha actividade emocionante ou viaxe"}', 'habit_adventure.png', 5),
    ('{"en": "Try New Recipe", "es": "Probar nueva receta", "gl": "Probar nova receita"}', '{"en": "Experiment with cooking a new dish", "es": "Experimenta cocinando un plato nuevo", "gl": "Experimenta cociñando un prato novo"}', 'habit_recipe.png', 6),
    ('{"en": "Social Gathering", "es": "Reunión social", "gl": "Reunión social"}', '{"en": "Organize or attend a social event", "es": "Organiza o asiste a un evento social", "gl": "Organiza ou asiste a un evento social"}', 'habit_social.png', 7),
    ('{"en": "Skill Assessment", "es": "Evaluación de habilidades", "gl": "Avaliación de habilidades"}', '{"en": "Assess and improve your skills", "es": "Evalúa y mejora tus habilidades", "gl": "Avalía e mellora as túas habilidades"}', 'habit_skill.png', 9)
